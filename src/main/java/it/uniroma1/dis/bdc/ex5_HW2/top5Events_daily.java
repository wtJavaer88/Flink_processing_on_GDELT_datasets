...
public class top5Events_daily {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        DataStream<Tuple3<String, String, Integer>> day_eventCode_one = withTimestamp
                .keyBy(1)
        ...
        day_eventCode_one
                ...
                .fold(new ArrayList<Tuple3<String, String, Integer>>(), new FoldFunction<Tuple3<String, String, Integer>, ArrayList<Tuple3<String, String, Integer>>>() {
                    public ArrayList<Tuple3<String, String, Integer>> fold(ArrayList<Tuple3<String, String, Integer>> top5, Tuple3<String, String, Integer> newTuple) {
                        ...
                        if (top5.size() < 5) {
                            ...
                            for (Tuple3<String, String, Integer> t : top5) {
                                if (t.f2 < min.f2) {
                                    min = t;
                                }
                            }
                            if (newTuple.f2 > min.f2) {
                ...
                }).writeAsText("./output/top5Events_daily", FileSystem.WriteMode.OVERWRITE);
        //.print();
    ...
    public static class Splitter implements FlatMapFunction<String, Tuple3<String, String, Integer>> {
        ...
        public void flatMap(String line, Collector<Tuple3<String, String, Integer>> out) throws Exception {
            ...
            String date = words[1];
            String event = words[26];

            if (!(event.isEmpty())) {
                out.collect(new Tuple3<>(date, event, 1));
            }
        }
    }
}
