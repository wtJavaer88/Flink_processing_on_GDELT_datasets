 ...
 */
public class top5Events_weekly {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        DataStream<Tuple3<String, String, Integer>> date_event_one =
                withTimestamp
                        .keyBy(1)
        ...
        date_event_one
                ...
                .fold(new ArrayList<Tuple3<String,String,Integer>>(),
                        ...
                        }).writeAsText("./output/top5Events_weekly", FileSystem.WriteMode.OVERWRITE);
        //.print();
